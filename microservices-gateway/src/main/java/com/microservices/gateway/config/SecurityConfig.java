...
import com.microservices.gateway.config.handler.CustomizeAuthenticationEntryPoint;
import com.microservices.gateway.config.handler.XTAccountAuthentication;
import com.microservices.gateway.config.handler.XTAuthenticationConverter;
import com.microservices.gateway.config.handler.XTReactiveAuthorizationManager;
...
public class SecurityConfig {
    ...
    SecurityWebFilterChain securityFilterChain(ServerHttpSecurity http) {
        http
                .authorizeExchange()
                // 需要权限访问de接口
                .pathMatchers("/admin/**", "/user/api-user/*/admin/**", "/elasticsearch/api-elasticsearch/admin/elasticsearch/**")
                .access(new XTReactiveAuthorizationManager("admin"))
